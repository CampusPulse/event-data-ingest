...
SOURCE_NAME = "rit_recreation_schedule"
...
def _get_normalized_event(site: dict, timestamp: str) -> schema.NormalizedEvent:
    # {"id": "7d24226e-8af5-47c5-88d2-c70539a834cf", "title": "Golf Simulator Open Recreation", "start": "2024-01-01T07:15:00.000", "end": "2024-01-01T08:15:00.000", "backgroundColor": "#FECBA5", "textColor": "#000000", "allDay": false}
    return schema.NormalizedEvent(
        identifier = _get_id(site),#: str
        title = site.get("title"),#: Optional[str]
        # location = ,#: Optional[Location]
        # date = ,#: Optional[StringDate]
        isAllDay = site.get("allDay"),#: Optional[bool]
        start = site.get("start"),#: Optional[StringTime]
        end = site.get("end"),#: Optional[StringTime]
